    ...
    var itemsData = [
      {
        ...
        desc:
          "Healthy cells vs Infected cells. Python simulation using the Pygame framework.",
      ...
      },
      {
        name: "Whodunit Padma",
        desc:
          "Play as Padma, the ship's AI, in this sci-fi murder mystery short listed for the Tranzfuser Fund 2016. Developed in 3 months using Unity/C#/Ink.",
      ...
      },
      {
        ...
        desc:
          "Project for multinational pharmaceutical company simulating the effects of sight disorders in VR. Created in Unity for Oculus VR/Google Cardboard.",
        img: "link-vr.jpg",
        date: "2016",
      ...
      },
      {
        ...
        desc:
          "Created in 8 hours for the EGX Rezzed Creative Assembly Game Jam. Developed using pure Javascript.",
      ...
      },
      {
        ...
        desc:
          "Bespoke website, branding and promotional material for London based beauty studio.",
      ...
      },
      {
        ...
        desc:
          "You are a giant sentient iceberg washed up on a tropical beach. Run as far as you can before you melt. Created in a week whilst sailing the Andaman Sea with American McGee for Pirate Jam 2017.",
      ...
      },
      {
        name: "Planet Sloth",
        desc:
          "Plant seeds and grow trees in this reforestation idle game. Created over a weekend in Unity as part of Slow Game Jam 2017.",
      ...
      },
      {
        name: "iTracR",
        desc:
          "Commercial timecard and resource management software. Created using Django, MySQL and web technologies.",
      ...
      },
      {
        ...
        desc:
          "Headless RESTful document management microservice for the UK Ministry of Justice. Created using SpringBoot and Postgres.",
        img: "link-moj.png",
        date: "2017",
      ...
      },
      {
        name: "eJudiciary",
        desc:
          "Bespoke SharePoint platform for the Royal Courts of Justice. Created in close collaboration with high court judges.",
        img: "web_rcj.jpg",
        date: "2017",
        filter: ["software", "java"],
      },
      ...
      },
      {
        ...
        desc:
          "WordPress website for international opera singer and travel blogger.",
      ...
      },
      {
        name: "Stop That Baby",
        desc:
          "Asymmetric 1 v 1 local multiplayer on one keyboard or with two controllers. Created for Pirate Jam 2018 whilst sailing the Andaman Sea, surviving storms and sipping SamSong.",
      ...
      },
      {
        name: "AFC Website",
        desc:
          "Bespoke showcase site for London based fire and security company.",
      ...
      },
      {
        name: "Feedr",
        desc:
          "React based commerce site and Android/iOS apps for fast growing food tech startup.",
      ...
      },
      {
        ...
        desc:
          "Simple arcade style timing/reaction game. Inspired by Lemmings and a pedestrian crossing light in Romania. Created whilst sailing the Andaman Sea for Pirate Jam 2020.",
      ...
      },
      {
        ...
        desc:
          "Supported local food charity set up their website and delivery online",
